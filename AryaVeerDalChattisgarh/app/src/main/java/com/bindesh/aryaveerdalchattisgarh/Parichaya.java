...
public class Parichaya extends AppCompatActivity {

    private final String JSON_URL = "https://aryaveerdal.in/all-json/parichay.json" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parichaya);
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Parichaya.this);
